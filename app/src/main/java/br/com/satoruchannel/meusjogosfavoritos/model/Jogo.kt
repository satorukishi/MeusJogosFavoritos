package br.com.satoruchannel.meusjogosfavoritos.model

import android.os.Parcel
import android.os.Parcelable

data class Jogo(val titulo: String, val descricao: String, val anoLancamento: Int,
                val fotoId: Int, val bannerId: Int) : Parcelable {
